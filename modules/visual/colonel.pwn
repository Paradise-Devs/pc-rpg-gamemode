/*******************************************************************************
* FILENAME :        modules/visual/colonel.pwn
*
* DESCRIPTION :
*       Create/Destroy and Show home invasion mission GUI functions.
*
* NOTES :
*       -
*
...
ShowPlayerColonelUI(playerid)
{
    ...
    UI[playerid][0] = CreatePlayerTextDraw(playerid, 493.000000, 148.000000, "barulho");
    ...
    new output[27];
    format(output, sizeof(output), "Luz do dia           %02d:%02d", hour, minute);
